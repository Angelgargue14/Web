...
DESCUENTO DECIMAL(4) COMMENT 'PORCENTAJE DE DESCUENTO  EJEMPLO: 12,02',
...
IMPUESTO DECIMAL(5,2) COMMENT 'Dato porcentual',
...
SELECT C.MESA,A.NOMBRE, C.CANTIDAD, C.DESCUENTO,A.PRECIO, (A.PRECIO*C.CANTIDAD) AS TOTAL,A.DESCRIPCION, A.ID_ARTICULO 
FROM CARRITOS C, ARTICULOS A 
WHERE C.ID_ARTICULO=A.ID_ARTICULO;
